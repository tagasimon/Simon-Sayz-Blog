...
<p><img style="float: left; margin:5px 20px 5px 1px; width:40%" src="https://lh3.googleusercontent.com/NptyNjT2skhzb1eEicjn-ChHPpSUeGCsp4dPwie9Iu2Y0wlRnOKF_vIloGi8lKCJ1_0"></p>
<p>[Safe Boda](https://safeboda.com/ug/) is an app with a social mission: to improve the welfare and livelihoods in Africa by empowering people.
[Safe Boda](https://safeboda.com/ug/) also works on providing value to consumers and drivers with additional financial services, payments and other on-demand services to keep Africa moving forward.
...
*Stop Words* and also Words like  "Safe Boda", "Safe", "Boda" are filtered out as they don't bring much value to this analysis and way too common `r emo::ji("cut")`
