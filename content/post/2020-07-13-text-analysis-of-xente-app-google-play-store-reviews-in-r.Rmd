---
title: "Text Analysis of Xente App Google Play Store Reviews in R"
author: "Simon Sayz"
date: '2020-07-12'
output:
  word_document:
...
- ''
summary: ''
slug: text-analysis-of-xente-app-google-play-store-reviews-in-r
editor_options:
...
<p><img style="float: left; margin:5px 20px 5px 1px; width:40%" src="https://www.xente.co/assets/images/hero-img.jpg"></p>
<p>Xente is payments, tickets and shopping in one app. [Xente](https://www.xente.co/), is a one-stop mobile shopping application. 
...
Xente Clearly replies to a big chunk of its customers on Google play store
```{r}
...
*Stop Words* and also Words like  "App" and "Xente" are filtered out as they don't bring much value to this analysis and way too common `r emo::ji("cut")`
